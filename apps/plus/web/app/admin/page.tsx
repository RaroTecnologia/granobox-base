    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-gray-500">
          Gerencie organizações, planos e assinaturas do Granobox
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
        <div className="bg-white overflow-hidden shadow rounded-lg">
          ...
          <div className="bg-gray-50 px-5 py-3">
            <div className="text-sm">
              <Link href="/admin/organizacoes" className="font-medium text-indigo-700 hover:text-indigo-900">
                Ver todas
              </Link>
            </div>
          </div>
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          ...
          <div className="bg-gray-50 px-5 py-3">
            <div className="text-sm">
              <Link href="/admin/planos" className="font-medium text-indigo-700 hover:text-indigo-900">
                Ver todas
              </Link>
            </div>
          </div>
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          ...
          <div className="bg-gray-50 px-5 py-3">
            <div className="text-sm">
              <Link href="/admin/usuarios" className="font-medium text-indigo-700 hover:text-indigo-900">
                Ver todos
              </Link>
            </div>
          </div>
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          ...
          <div className="bg-gray-50 px-5 py-3">
            <div className="text-sm">
              <Link href="/admin/relatorios" className="font-medium text-indigo-700 hover:text-indigo-900">
                Ver relatórios
              </Link>
            </div>
          </div>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-gray-500">
                  Cadastrar nova padaria/doceria
                </p>
              </div>
            </Link>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-yellow-700">
                    <p>
                      Comece cadastrando sua primeira organização para gerenciar assinaturas.
                    </p>
                  </div>
                  <div className="mt-4">
