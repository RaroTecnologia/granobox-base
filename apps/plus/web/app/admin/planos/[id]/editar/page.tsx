    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({
          ...
          recursos: {
            usuarios: data.recursos.usuarios,
            receitas: data.recursos.receitas,
            backup: data.recursos.backup,
            suporte: data.recursos.suporte,
            api: data.recursos.api || false
          },
          ativo: data.ativo
        })
      } else {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-500">Carregando plano...</p>
        </div>
      </div>
    )
  }
  ...
  if (!plano) {
    return (
      <div className="text-center py-12">
        ...
        <h3 className="mt-2 text-sm font-medium text-gray-900">Plano não encontrado</h3>
        <div className="mt-6">
          <Link
            href="/admin/planos"
